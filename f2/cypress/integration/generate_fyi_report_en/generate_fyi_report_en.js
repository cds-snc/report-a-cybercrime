...
When('I fill to Whathappened page forms', () => {
    cy.get('form').find('[name="whatHappened"]').type('TC: fyi-What happened tell more. Include things such as how you were contacted, what they asked for, and who they claimed to be')
});

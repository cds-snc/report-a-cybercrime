...
When('I navigate to Howwereyourmoney page fill all forms', () => {
  ...
  cy.get('form')
    ...
    .type('Howwereyourmoney tell more')
  cy.contains('Continue')
    .first()
    .click({ force: true })
})

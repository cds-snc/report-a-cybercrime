...
When('I fill Whoareyoureporting page forms', () => {
    ...
    cy.get('form').find('[id="someoneDescription"]').type('I am reporting for my sister. Her name is Legia Freshlay')
});
...
When('I fill to Whathappened page forms', () => {
    cy.get('form').find('[name="whatHappened"]').type('TC: Other-NotInUsePC. What happened tell more')
});
...
When('I fill to yourLocation page forms', () => {
    cy.get('form').find('[id="postalCode"]').type('b0a1a2')
});

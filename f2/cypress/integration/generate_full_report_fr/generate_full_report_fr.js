...
When('I fill Whoareyoureporting page forms', () => {
    ...
    cy.get('form').find('[id="businessDescription"]').type('Souvenir du Quebec, https://www.souvenirduquebec.com/, (514) 895-0746')
});
...
When('I fill howdiditstart page forms', () => {
    ...
    cy.get('form').find('[name="application"]').type('Noms d’applications où vous avez communiqué Application')

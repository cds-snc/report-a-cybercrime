...
formDefaults is a Javascript object contains a list of all fields from report with empty values asigned for each field.
...
Here is a example of money lost page with input fields(text) and checkbox(array)

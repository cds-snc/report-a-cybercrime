...
<Story name="Form">
  <Form
    ...
    render={({ handleSubmit, values }) => (
      <Stack as="form" onSubmit={handleSubmit}></Stack>
    )}
  />
</Story>
...
## Fields and Form Array Controls

<Story name="Fields and Form Array Controls"></Story>

View [Field](/?path=/docs/components-field--input-field) documentation for more information on how to use it in a Form.

View [FormArrayControl](/?path=/docs/components-form-array-control--default-story)
documentation for more information on how to place radio and checkbox lists in a
Form.

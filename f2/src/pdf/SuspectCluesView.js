...
export const SuspectCluesView = (props) => {
  ...
  return (
    <View style={pdfStyles.section}>
      <Text style={pdfStyles.title}>{lang["confirmationPage.suspectClues.title"]}</Text>      
      {containsData(suspectClues) ? (
        ...
        <Text style={pdfStyles.sectionContent}>{lang["confirmationPage.suspectClues.nag"]}</Text>
      )}

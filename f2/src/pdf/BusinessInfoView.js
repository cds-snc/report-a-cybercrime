...
export const BusinessInfoView = (props) => {
  ...
  return (
    <View style={pdfStyles.section}>
      <Text style={pdfStyles.title}>{lang["confirmationPage.businessInfo.title"]}</Text>      
      {containsData(businessInfo) ? (
        ...
        <Text style={pdfStyles.sectionContent}>{lang["confirmationPage.businessInfo.nag"]}</Text>
      )}

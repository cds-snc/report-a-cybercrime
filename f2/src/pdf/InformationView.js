...
export const InformationView = (props) => {
  ...
  return (
    <View style={pdfStyles.section}>
      <Text style={pdfStyles.title}>{lang["confirmationPage.contactTitle"]}</Text>      
      {containsData(personalInformation) ? (
        ...
        <Text style={pdfStyles.sectionContent}>{lang["confirmationPage.personalInformation.nag"]}</Text>
      )}

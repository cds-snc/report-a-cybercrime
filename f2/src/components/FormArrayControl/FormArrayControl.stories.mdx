...
A FormArrayControl can be used to create a group of inputs. This is useful when you want to group inputs, wheter they are checkboxes, radios or text inputs. FormArrayControl will ensure the group of fields are described by a label and fully accessible.
